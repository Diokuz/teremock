...
var Tes = /** @class */ (function () {
    ...
    Tes.prototype.send = function (method, data) {
        this.socket.send(JSON.stringify({ method: method, data: data }));
    };
    Tes.prototype.handle = function (str) {
    ...
    Tes.prototype.start = function (options) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var wsUrl, tOptions, resultWsUrl, reject;
            var _this = this;
            return tslib_1.__generator(this, function (_a) {
                wsUrl = options.wsUrl, tOptions = tslib_1.__rest(options, ["wsUrl"]);
                resultWsUrl = (wsUrl !== null && wsUrl !== void 0 ? wsUrl : "ws://localhost:" + exports.DEFAULT_WS_PORT + "/path/doesnt/matter");
                this.startPromise = new Promise(function (res, rej) {
                    _this.startResolve = res;
                    reject = rej;
                });
...
/* WEBPACK VAR INJECTION */(function(__dirname) {/* harmony import */ var _dist_express__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../dist/express */ "./dist/express/index.js");
/* harmony import */ var _dist_express__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_dist_express__WEBPACK_IMPORTED_MODULE_0__);


async function run() {
  await _dist_express__WEBPACK_IMPORTED_MODULE_0___default.a.start({
...
/* WEBPACK VAR INJECTION */}.call(this, "examples/teremock-express"))
